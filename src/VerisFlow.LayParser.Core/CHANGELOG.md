# Changelog - VerisFlow.VenusDeckParser.Core

All notable changes to the `VerisFlow.VenusDeckParser.Core` package will be documented in this file.
...
* Initial release of the `VerisFlow.VenusDeckParser.Core` package at version 0.1.0.
